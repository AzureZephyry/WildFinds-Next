-- Corrective migration for claim submission context runtime safety.
-- Replaces the function definition without changing tables, RLS, or data.
...
-- select pg_get_functiondef('public.get_claim_submission_context(uuid)'::regprocedure);
-- select * from information_schema.routine_privileges
-- where routine_schema = 'public' and routine_name = 'get_claim_submission_context';
-- select * from public.get_claim_submission_context(null::uuid);
